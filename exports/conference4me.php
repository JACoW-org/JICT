...
define( 'CACHE', sprintf( '%s/conference4me.json', $cfg['data_path'] ));

header( 'Content-Type: application/json' );

$in =[
    'event' =>sprintf( "%s/indico/export_event_%d.json", $cfg['tmp_path'], $eid ),
    'timetable' =>sprintf( "%s/indico/export_timetable_%d.json", $cfg['tmp_path'], $eid )
    ];
