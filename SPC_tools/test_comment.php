...
$req =$Indico->request( "/event/{id}/abstracts/".$abstract_id."/comment", 'POST', array( 'text' => 'indico: '.$comment , 'visibility' => "reviewers" ,  'csrf_token' => '77c259b8-77c1-4b55-b0cd-078a076c2238') , array( 'return_data' =>true, 'quiet' =>true ) );
//$req =$Indico->request( "/event/{id}/abstracts/".$abstract_id."/comment", 'POST', array( 'text' => $comment , 'visibility' => "judges") , array( 'return_data' =>true, 'quiet' =>true ) );
